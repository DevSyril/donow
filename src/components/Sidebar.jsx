...
export const Sidebar = () => {
    ...
    return (
        <div className='w-[20%] min-h-[100vh] border-x-2 flex flex-col py-6 px-8 gap-10'>


            <div className='flex py-6 rounded gap-2'>
            ...
            <div className="flex items-center gap-6 border-2 rounded-xl px-4 py-2 cursor-pointer justify-center
                hover:bg-red-500 hover:px-4 hover:py-2 hover:rounded-xl hover:text-white transition-all mt-[10rem] ">
